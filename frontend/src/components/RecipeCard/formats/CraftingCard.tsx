...
function CraftingCard({itemsGrid, resultItem, resultItemAmount}: CraftingCardProps) {
    return (
...
export function CraftingShapedCard({recipe}: CraftingShapedCardProps) {
    ...
    return <CraftingCard itemsGrid={itemsGrid} resultItem={recipe.resultItem} resultItemAmount={recipe.resultItemAmount}/>
}
